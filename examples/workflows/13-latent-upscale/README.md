...
10. 量化H3底模使用`LoraLoaderBypassModelOnly`加载`minimax_h3_fl2v_turbo_4step_v0.1_comfyui_alpha8.safetensors`、强度1.0。普通`minimax_h3_fl2v_turbo_4step_v0.1_comfyui.safetensors`为已否决转换，不要替换回去。
