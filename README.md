...
| Audio Refine低步数音频精修 | `18-audio-refine/2026-08-26_H3_Audio_Refine_Turbo4_Plus_Refine4_Advanced_EXP.json` | 原始与候选共用同一MODEL、conditioning和完整AV latent | 1056×608×124的Turbo4+Refine4单次实跑和严格解码通过；一名评审者最终确认精修组略好、原始组略轻。这是单素材有限偏好，不足以推广为默认，因此Quality Gate继续默认false并保留原始AV |
